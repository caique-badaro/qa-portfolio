document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadContent(url) {
    fetch(url)
      ...
      .then(html => {
        ...
        contentDiv.scrollTop = 0; // Garante que o scroll comece do topo
      })
      .catch(error => {
  ...
  // Eventos dos botões
  button1.addEventListener("click", () => openPopup("content/bottom-sheet_modal_heatmap-move-mouse.html"));
  button2.addEventListener("click", () => openPopup("content/bottom-sheet_modal_heatmap-clicks.html"));
  button3.addEventListener("click", () => openPopup("content/bottom-sheet_modal_heatmap-scroll.html"));

  // Fecha o popup ao clicar nele ou no overlay
